...
s3_client = S3Client(
    access_key=settings.storage_settings.access_key,
    secret_key=settings.storage_settings.secret_key,
    bucket_name=settings.storage_settings.bucket_name,
    storage_url=settings.storage_settings.bucket_url,
)
